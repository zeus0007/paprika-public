...
class CertSaving extends StatefulWidget {
  CertSaving({this.goNext, this.scrollToTop});
  final Function goNext;
  final Function scrollToTop;
  @override
  _CertSavingState createState() => _CertSavingState();
}

class _CertSavingState extends State<CertSaving> {
  var count = 1;
