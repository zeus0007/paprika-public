...
class CertInvestment extends StatefulWidget {
  CertInvestment({this.goNext, this.scrollToTop});
  final Function goNext;
  final Function scrollToTop;
  @override
  _CertInvestmentState createState() => _CertInvestmentState();
}

class _CertInvestmentState extends State<CertInvestment> {
  var count = 1;
